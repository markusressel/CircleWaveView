...
object PreferencesHelper {
     ...
     */
    fun getDimen(context: Context, @StringRes key: Int,
                 @DimenRes defaultValue: Int): Float {
        val sharedPreferences = context.getSharedPreferences(SHARED_PREFS_NAME,
     ...
     * @return integer
     */
    fun getInteger(context: Context, @StringRes key: Int,
                   @IntegerRes defaultValue: Int): Int {
        val sharedPreferences = context.getSharedPreferences(SHARED_PREFS_NAME,
                Context.MODE_PRIVATE)
        val integerAsString = sharedPreferences.getString(context.getString(key), null)
        return integerAsString?.toInt() ?: context.resources.getInteger(defaultValue)
    }
     ...
     */
    fun getColor(context: Context, @StringRes key: Int,
                 @ColorInt defaultValue: Int): Int {
        val sharedPreferences = context.getSharedPreferences(SHARED_PREFS_NAME,
                Context.MODE_PRIVATE)
