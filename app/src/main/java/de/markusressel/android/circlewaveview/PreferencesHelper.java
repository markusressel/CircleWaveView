...
public final class PreferencesHelper {
     ...
     */
    public static float getDimen(@NonNull Context context, @StringRes int key,
            @DimenRes int defaultValue) {
     ...
     * @return integer
     */
    public static int getInteger(@NonNull Context context, @StringRes int key,
            @IntegerRes int defaultValue) {
        SharedPreferences sharedPreferences = context.getSharedPreferences(SHARED_PREFS_NAME,
                Context.MODE_PRIVATE);
     ...
     */
    public static int getColor(@NonNull Context context, @StringRes int key,
